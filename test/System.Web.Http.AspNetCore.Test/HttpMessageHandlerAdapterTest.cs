...
namespace System.Web.Http.AspNetCore
{
    public class HttpMessageHandlerAdapterTest
    {
        ...
        [Fact]
        public async Task Invoke_IfBufferPolicyEnablesInputBuffering_Throws()
        {
            // Arrange
                ...
                bufferPolicySelector)))
            {
                ...
                // Act & Assert
                await Assert.ThrowsAsync<NotSupportedException>(() => product.Invoke(httpContext));
            }
        }
        ...
        public class HandlerStub : HttpMessageHandler
        {
            ...
            protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
            {
                ...
                {
                    request.Options.TryAdd(HttpPropertyKeys.NoRouteMatched, true);
                }
