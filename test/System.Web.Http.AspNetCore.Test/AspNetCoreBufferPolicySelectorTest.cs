...
namespace System.Web.Http.AspNetCore
{
    public class AspNetCoreBufferPolicySelectorTest
    {
        ...
        {
            Assert.False(new AspNetCoreBufferPolicySelector().UseBufferedInputStream(null));
        }
        ...
        public void UseBufferedOutputStream_ReturnsTrue_ForObjectContent()
        {
            ...
            Assert.True(new AspNetCoreBufferPolicySelector().UseBufferedOutputStream(response));
        }
        ...
        public void UseBufferedOutputStream_ReturnsFalse_ForSpecifiedContentLength()
        {
            ...
            Assert.False(new AspNetCoreBufferPolicySelector().UseBufferedOutputStream(response));
        }
